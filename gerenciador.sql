...
CREATE TABLE `curso` (
  ...
  KEY `id_sala` (`id_sala`),
  CONSTRAINT `curso_ibfk_1` FOREIGN KEY (`id_professor`) REFERENCES `usuario` (`id`),
...
INSERT INTO `usuario` VALUES (1,'a@gmail.com','1234','Bananinha','');
...
-- Dump completed on 2024-05-07  9:00:28
